...
import org.xbrl.x2003.instance.ContextDocument.Context;
...
/**
 * Hard-coded IITR context: Intermediary + TrueAndCorrect (duration).
 * Static parts (ID, dimensions, scheme) are fixed here.
 * Dynamic parts are applied via SETTERS keyed by field classes referenced in annotations.
 */
public final class IntermediaryContext {

    public static final String ID = "INT.TrueAndCorrect";
    ...
    public static Context createEmpty() {
        ...
        addExplicitMember(segment.getDomNode(),
                "http://www.sbr.gov.au/ato/iitr", "ReportPartyTypeDimension", "Intermediary");
        addExplicitMember(segment.getDomNode(),
                "http://www.sbr.gov.au/ato/iitr", "DeclarationTypeDimension", "TrueAndCorrect");
    ...
    private record ContextValue(Context ctx) {}
}
